# Claude Code Guidelines — agendapro
...
2. Revisar `/root/apps/wiki/projects/agendapro/overview.md` si existe.

Conocimiento acumulado de este proyecto en `/root/apps/wiki/projects/agendapro/`.
